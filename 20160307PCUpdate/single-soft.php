<?php get_header(); ?>
      ...
      <div class="row clearfix">
        ...
        <div class="single_soft_title">
          <h1> <?php the_title(); ?> <span><?php $tvalue=get_post_meta($post->ID,"xlgs_value",true); 
		  if(strpos($tvalue,'exe')){
				echo "<img src='".get_template_directory_uri()."/images/02.png'/>PC端软件";
				}elseif(strpos($tvalue,'apk')){
				echo "<img src='".get_template_directory_uri()."/images/01.png'/>手机端软件";
				}else{
                echo "<img src='".get_template_directory_uri()."/images/03.png'/>压缩包软件";
				}
