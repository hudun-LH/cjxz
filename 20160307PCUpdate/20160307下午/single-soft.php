<?php get_header(); ?>
      ...
      <div class="row clearfix">
        ...
        <div class="single_soft_title">
          <h1> <?php the_title(); ?> <?php $tvalue=get_post_meta($post->ID,"xlgs_value",true); 
		  if(strpos($tvalue,'exe')){
				echo "<span><img src='".get_template_directory_uri()."/images/02.png'/>PC端软件</span>";
				}elseif(strpos($tvalue,'apk')){
				echo "<span class='android'><img src='".get_template_directory_uri()."/images/01.png'/>安卓端软件</span>";
				}else{
                echo "<span><img src='".get_template_directory_uri()."/images/02.png'/>PC端软件</span>";
				}
