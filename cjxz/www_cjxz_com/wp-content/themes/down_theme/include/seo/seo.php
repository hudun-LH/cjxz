...
function web589SEO_meta_menu_page(){
	add_submenu_page('generalpage','meta','meta设置','manage_options','web589_meta','web589SEO_meta_menu_page_form');
}
...
function web589_post_meta_box(){
	...
	add_meta_box('web589_post_meta_box','自定义seo meta','Web589Meta_postmeta_form','soft','normal','high');
	add_meta_box('web589_post_meta_box','自定义seo meta','Web589Meta_postmeta_form','topic','normal','high');
}
...
//add cat metabox
add_action('category_edit_form','web589_cat_meta_box');
add_action('softs_edit_form','web589_cat_meta_box');
add_action('topics_edit_form','web589_cat_meta_box');
...
//add tag metabox
add_action('post_tag_edit_form','web589_tag_meta_box');
...
function web589_meta_action(){
	...
	if((is_tax() || is_category()) && !is_paged()){
