...
function ashuwp_add_option_page($pageinfo, $pageinfo){
  new ashuwp_class_options($pageinfo, $pageinfo);
}
...
class ashuwp_framework_core {
  ...
  function enqueue_css_js() {
    ...
    wp_enqueue_script('bootstrap-modals', get_template_directory_uri(). '/js/bootstrap-modal.js','','',true);
    wp_enqueue_script('soft_add_js', get_template_directory_uri(). '/js/soft-add.js');
