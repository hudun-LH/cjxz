<?php get_header(); ?>
      ...
      <?php get_template_part('partials/part','softtop'); ?>
        ...
        <div class="right_main">
          ...
          <div id="soft_list">
            <div class="cat_title">
              ...
              global $wp_query
              ?>
              <h2><?php single_cat_title(); ?><span>共有<?php echo $wp_query->found_posts; ?>款软件</span></h2>
            </div>
            <div class="softs">
              <?php
              ...
              <div class="soft_item">
                <div class="baseinfo clearfix">
                  ...
                  <a href="<?php echo get_term_link($current_term,'softs'); ?>" class="cat">[<?php single_cat_title(); ?>]</a>
                </div>
